...
Copy the AddTrustExternalCARoot-2048.pem from this link, SSL upgrades on rubygems.org and RubyInstaller versions (https://gist.github.com/luislavena/f064211759ee0f806c88) go to the section under; Step 1: Obtain the new trust certificate and proceed from there. 
